...
📖 **[مکمل دستاویزات →](https://github.com/adurham/hermes-agent/tree/main/website/docs)**
...
یہ آپ کو OAuth کے ذریعے لاگ ان کرواتا ہے، Nous کو آپ کا پرووائیڈر مقرر کرتا ہے، اور ٹول گیٹ وے کو آن کر دیتا ہے۔ `hermes portal info` کمانڈ استعمال کر کے آپ کسی بھی وقت چیک کر سکتے ہیں کہ کون کون سی سروسز منسلک ہیں۔ مکمل تفصیلات [Tool Gateway دستاویزات کے صفحے](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/tool-gateway.md) پر موجود ہیں۔
...
مکمل کمانڈ لسٹ کے لیے، [CLI گائیڈ](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/cli.md) اور [میسجنگ گیٹ وے گائیڈ](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/messaging/index.md) دیکھیں۔

---

## دستاویزات (Documentation)

تمام دستاویزات **[github.com/adurham/hermes-agent/website/docs](https://github.com/adurham/hermes-agent/tree/main/website/docs)** پر موجود ہیں:

<div dir="ltr">

| سیکشن (Section)                                                                                     | تفصیل (What's Covered)                                     |
| --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| [فوری آغاز (Quickstart)](https://github.com/adurham/hermes-agent/blob/main/website/docs/getting-started/quickstart.md)     | انسٹالیشن → سیٹ اپ → 2 منٹ میں پہلی بات چیت شروع کریں       |
| [CLI کا استعمال](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/cli.md)                         | کمانڈز، کی بائنڈنگز (keybindings)، پرسنلٹیز (personalities)، سیشنز |
| [کنفیگریشن (Configuration)](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/configuration.md)    | کنفگ فائل، پرووائیڈرز، ماڈلز، اور تمام آپشنز               |
| [میسجنگ گیٹ وے](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/messaging/index.md)                    | ٹیلی گرام، ڈسکارڈ، سلیک، واٹس ایپ، سگنل، ہوم اسسٹنٹ         |
| [سیکیورٹی (Security)](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/security.md)              | کمانڈ کی منظوری، DM پیئرنگ (pairing)، کنٹینر آئسولیشن       |
| [ٹولز اور ٹول سیٹس](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/tools.md)          | 40 سے زائد ٹولز، ٹول سیٹ سسٹم، ٹرمینل بیک اینڈز             |
| [مہارتوں کا سسٹم (Skills System)](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/skills.md)| پروسیجرل (Procedural) میموری، سکلز ہب، نئی مہارتیں بنانا    |
| [میموری (Memory)](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/memory.md)            | مستقل میموری، یوزر پروفائلز، بہترین طریقہ کار              |
| [MCP انضمام (Integration)](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/mcp.md)      | صلاحیتوں کو بڑھانے کے لیے کسی بھی MCP سرور کو جوڑیں        |
| [کرون (Cron) شیڈیولنگ](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/cron.md)         | پلیٹ فارم ڈیلیوری کے ساتھ شیڈول کیے گئے کام                 |
| [کانٹیکسٹ (Context) فائلز](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/context-files.md)| پروجیکٹ کا سیاق و سباق (context) جو ہر بات چیت پر اثر انداز ہوتا ہے |
| [آرکیٹیکچر (Architecture)](https://github.com/adurham/hermes-agent/blob/main/website/docs/developer-guide/architecture.md) | پروجیکٹ کا ڈھانچہ، ایجنٹ لوپ، اہم کلاسز                    |
| [تعاون (Contributing)](https://github.com/adurham/hermes-agent/blob/main/website/docs/developer-guide/contributing.md)     | ڈیویلپمنٹ سیٹ اپ، PR کا طریقہ کار، کوڈنگ کا انداز          |
| [CLI حوالہ جات (Reference)](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/cli-commands.md)      | تمام کمانڈز اور فلیگز (flags)                              |
| [انوائرمنٹ ویری ایبلز](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/environment-variables.md)  | مکمل انوائرمنٹ ویری ایبل حوالہ جات                         |
...
ہم آپ کے تعاون کا خیرمقدم کرتے ہیں! ڈیویلپمنٹ سیٹ اپ، کوڈ کے انداز اور PR کے طریقہ کار کے لیے براہ کرم ہماری [Contributing گائیڈ](https://github.com/adurham/hermes-agent/blob/main/website/docs/developer-guide/contributing.md) دیکھیں۔
...
- 🐛 [مسائل (Issues)](https://github.com/adurham/hermes-agent/issues)
