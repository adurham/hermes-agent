...
$RepoUrlSsh = "git@github.com:adurham/hermes-agent.git"
$RepoUrlHttps = "https://github.com/adurham/hermes-agent.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/adurham/hermes-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/adurham/hermes-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/adurham/hermes-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
function Install-Desktop {
    ...
    #
    #     The resedit path also sidesteps #105629: that bug is specific to
    #     rcedit, which cannot commit to the ASAR-integrity-rewritten PE and
