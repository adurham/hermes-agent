...
**文档：** https://github.com/adurham/hermes-agent/tree/main/website/docs
...
平台文档：https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/messaging/index.md
...
在交互式聊天会话中输入这些命令。新命令会不定期上线；如果以下内容看起来过时，请在会话内运行 `/help` 获取权威列表，或查看[实时斜杠命令参考](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/slash-commands.md)。命令注册表的权威来源是 `hermes_cli/commands.py` — 每个消费方（自动补全、Telegram 菜单、Slack 映射、`/help`）均从中派生。
...
完整配置参考：https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/configuration.md
...
完整提供商文档：https://github.com/adurham/hermes-agent/blob/main/website/docs/integrations/providers.md
...
用户文档：https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/cron.md
...
用户文档：https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/curator.md
...
用户文档：https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/kanban.md
...
| 查找内容... | 位置 |
|----------------|----------|
| 配置选项 | `hermes config edit` 或[配置文档](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/configuration.md) |
| 可用工具 | `hermes tools list` 或[工具参考](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/tools-reference.md) |
| 斜杠命令 | 会话内 `/help` 或[斜杠命令参考](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/slash-commands.md) |
| Skill 目录 | `hermes skills browse` 或[Skill 目录](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/skills-catalog.md) |
| 提供商设置 | `hermes model` 或[提供商指南](https://github.com/adurham/hermes-agent/blob/main/website/docs/integrations/providers.md) |
| 平台设置 | `hermes gateway setup` 或[消息文档](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/messaging/index.md) |
| MCP 服务器 | `hermes mcp list` 或[MCP 指南](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/mcp.md) |
| Profiles | `hermes profile list` 或[Profiles 文档](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/profiles.md) |
| Cron 任务 | `hermes cron list` 或[Cron 文档](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/cron.md) |
| 记忆 | `hermes memory status` 或[记忆文档](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/memory.md) |
| 环境变量 | `hermes config env-path` 或[环境变量参考](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/environment-variables.md) |
| CLI 命令 | `hermes --help` 或[CLI 参考](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/cli-commands.md) |
