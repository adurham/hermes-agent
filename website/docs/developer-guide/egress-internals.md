...
- User-facing setup + troubleshooting: [Egress proxy](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/egress/iron-proxy.md)
- Docker backend internals: [Docker](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/docker.md)
- Bitwarden Secrets Manager integration: [`hermes secrets bitwarden`](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/secrets/bitwarden.md)
