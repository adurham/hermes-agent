...
|---|---|---|
| Bundled | `plugins/memory/<name>/` | Ships with Hermes. Closed to new providers — see [CONTRIBUTING](https://github.com/adurham/hermes-agent/blob/main/CONTRIBUTING.md). |
