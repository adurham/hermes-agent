...
| [**deepseek-harness**](../user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-deepseek-harness.md) | Delegate coding to DeepSeek Harness (dsh), local endpoint. |
