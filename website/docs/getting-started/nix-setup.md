...
```bash
# Run the desktop app
nix run github:adurham/hermes-agent#desktop

# Or install persistently
nix profile install github:adurham/hermes-agent#desktop

# run the tui
nix run github:adurham/hermes-agent -- setup
nix run github:adurham/hermes-agent -- --tui

# or install it in your profile
nix profile install github:adurham/hermes-agent
hermes setup
hermes --tui
```
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:adurham/hermes-agent";
  };
...
```nix
{
  inputs.hermes-agent.url = "github:adurham/hermes-agent";
