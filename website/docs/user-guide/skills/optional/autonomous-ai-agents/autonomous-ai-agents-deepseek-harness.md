...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/autonomous-ai-agents/deepseek-harness` |
| Path | `optional-skills/autonomous-ai-agents/deepseek-harness` |
| Version | `0.1.0` |
| Author | Hermes Agent |
| License | MIT |
