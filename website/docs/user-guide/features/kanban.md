...
[`agent-merge-conflict-arbiter` optional skill](https://github.com/adurham/hermes-agent/blob/main/optional-skills/autonomous-ai-agents/agent-merge-conflict-arbiter/SKILL.md)
