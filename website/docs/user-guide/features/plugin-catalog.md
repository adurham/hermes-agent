...
[`plugin-catalog/`](https://github.com/adurham/hermes-agent/tree/main/plugin-catalog)
...
[plugin-catalog README](https://github.com/adurham/hermes-agent/tree/main/plugin-catalog);
