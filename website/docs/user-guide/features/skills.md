...
```bash
curl -fsSL https://raw.githubusercontent.com/adurham/hermes-agent/main/scripts/install.sh | bash -s -- --no-skills
```
...
[Skills Hub](https://github.com/adurham/hermes-agent/tree/main/website/docs) page — instead of a
