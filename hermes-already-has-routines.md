...
Full automation blueprints gallery: [github.com/adurham/hermes-agent/website/docs/reference/automation-blueprints-catalog](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/automation-blueprints-catalog.mdx)

Documentation: [github.com/adurham/hermes-agent](https://github.com/adurham/hermes-agent/tree/main/website/docs)

GitHub: [github.com/adurham/hermes-agent](https://github.com/adurham/hermes-agent)
