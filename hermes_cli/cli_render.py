...
def _render_final_assistant_content(text: str, mode: str = "render"):
    ...
    from cli import _preserve_windows_dot_segments_for_markdown, _rich_text_from_ansi, _strip_markdown_syntax, _STREAM_PAD, _terminal_columns, realign_markdown_tables
