...
def _migrate_to_31_aux_provider_first(results: Dict[str, Any], quiet: bool) -> None:
    # ── FORK — Version 30 → 31: convert auxiliary config to provider-first ──
    ...
    # (Shares upstream's v31 gate deliberately — it landed in the fork at the
    # same schema bump as upstream's verify_on_stop flip.)
    _c = _cfg()
    read_raw_config = _c.read_raw_config
    _persist_migration = _c._persist_migration
    convert_auxiliary_to_provider_first = _c.convert_auxiliary_to_provider_first
...
MIGRATIONS: Tuple[Tuple[int, Callable[[Dict[str, Any], bool], None]], ...] = (
    ...
    # FORK 30 → 31: convert task-first auxiliary blocks to the provider-first schema.
    (31, _migrate_to_31_aux_provider_first),
