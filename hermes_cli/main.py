...
def _print_curator_first_run_notice() -> None:
    ...
    print(
        "  Docs:         https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/curator.md"
    )
...
def _update_via_zip(args):
    ...
    if branch != "main":
        ...
        sys.exit(1)
    zip_url = (
        f"https://github.com/adurham/hermes-agent/archive/refs/heads/{branch}.zip"
    )
...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "prompt-size",
        "send", "sessions", "setup",
        "skills", "slack", "status", "submit", "tools", "uninstall", "update",
