...
def main():
    ...
    fallback_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/fallback-providers.md"
        ),
    )
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/secrets/index.md"
        ),
    )
    ...
    egress_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/egress/iron-proxy.md"
        ),
    )
