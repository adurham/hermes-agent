...
_REINSTALL_HINT = {
    True: "  iex (irm https://raw.githubusercontent.com/adurham/hermes-agent/main/scripts/install.ps1)",
    False: "  curl -fsSL https://raw.githubusercontent.com/adurham/hermes-agent/main/scripts/install.sh | bash"}
