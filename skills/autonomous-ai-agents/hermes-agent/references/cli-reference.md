...
https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/cli-commands.md
...
Docs: https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/messaging/index.md
...
|---|---|
| Config options | `hermes config edit` · [Configuration docs](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/configuration.md) |
| Tools / toolsets | `hermes tools list` · [Tools reference](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/tools-reference.md) |
| Skills catalog | `hermes skills browse` · [Skills catalog](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/skills-catalog.md) |
| Provider setup | `hermes model` · [Providers guide](https://github.com/adurham/hermes-agent/blob/main/website/docs/integrations/providers.md) |
| Env variables | `hermes config env-path` · [Env vars reference](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/environment-variables.md) |
