...
metadata:
  hermes:
    ...
    homepage: https://github.com/adurham/hermes-agent
...
**Docs:** https://github.com/adurham/hermes-agent/tree/main/website/docs
...
- User documentation: https://github.com/adurham/hermes-agent/tree/main/website/docs
- Source tree: https://github.com/adurham/hermes-agent
...
Platform docs: https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/messaging/index.md
...
authoritative list or see the [live slash commands reference](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/slash-commands.md).
...
Full config reference: https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/configuration.md
...
Full provider docs: https://github.com/adurham/hermes-agent/blob/main/website/docs/integrations/providers.md
...
User docs: https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/cron.md
...
User docs: https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/curator.md
...
User docs: https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/kanban.md
...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/configuration.md) |
| Available tools | `hermes tools list` or [Tools reference](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/tools-reference.md) |
| Slash commands | `/help` in session or [Slash commands reference](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/slash-commands.md) |
| Skills catalog | `hermes skills browse` or [Skills catalog](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/skills-catalog.md) |
| Provider setup | `hermes model` or [Providers guide](https://github.com/adurham/hermes-agent/blob/main/website/docs/integrations/providers.md) |
| Platform setup | `hermes gateway setup` or [Messaging docs](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/messaging/index.md) |
| MCP servers | `hermes mcp list` or [MCP guide](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/mcp.md) |
| Profiles | `hermes profile list` or [Profiles docs](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/profiles.md) |
| Cron jobs | `hermes cron list` or [Cron docs](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/cron.md) |
| Memory | `hermes memory status` or [Memory docs](https://github.com/adurham/hermes-agent/blob/main/website/docs/user-guide/features/memory.md) |
| Env variables | `hermes config env-path` or [Env vars reference](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/environment-variables.md) |
| CLI commands | `hermes --help` or [CLI reference](https://github.com/adurham/hermes-agent/blob/main/website/docs/reference/cli-commands.md) |
...
For occasional contributors and PR authors. Full developer docs: https://github.com/adurham/hermes-agent/tree/main/website/docs/developer-guide
