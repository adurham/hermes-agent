  ...
  upsertSubagent(
    ...
    patchTurnState(state => {
      ...
      const base: SubagentProgress = existing ?? {
        ...
        depth: p.depth ?? 0,
        fallbackActive: p.fallback_active ?? undefined,
        goal: p.goal,
        id,
        index: p.task_index,
        ...
        primaryModel: p.primary_model ?? undefined,
        primaryProvider: p.primary_provider ?? undefined,
      ...
      const next: SubagentProgress = {
        ...
        fallbackActive: p.fallback_active ?? base.fallbackActive,
        ...
        modelLabel: p.model_label ?? base.modelLabel,
        outputTail,
        outputTokens: p.output_tokens ?? base.outputTokens,
        parentId: p.parent_id ?? base.parentId,
        primaryModel: p.primary_model ?? base.primaryModel,
        primaryProvider: p.primary_provider ?? base.primaryProvider,
