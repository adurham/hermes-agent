...
def test_clarify_callback_fires_attention_signals():
    """CLIModalMixin._clarify_callback (the live interactive clarify prompt
    path, resolved as HermesCLI._clarify_callback) must ring the bell / fire a
    native notification via the cli object.
