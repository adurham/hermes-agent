...
class TestAnthropicOAuthFlag:
    ...
    def test_api_key_no_oauth_flag(self, monkeypatch, spec_anthropic_client):
        ...
        with patch("agent.anthropic_credentials.resolve_anthropic_token", return_value="sk-ant...1234"), \
...
class TestAnthropicAuxiliaryReasoningTranslation:
    ...
    def test_reasoning_config_reaches_native_anthropic_wire_kwargs(self):
        ...
        # see anthropic_adapter.py comment on the thinking/output_config
        # block) — no "display" key present at all.
