...
def test_interactive_platforms_keep_warning_only_default(platform):
    # FORK: hard_stop_enabled defaults True on every platform, interactive included
    # (upstream keeps interactive platforms warn-only by default). See FORK.md
    # 2026-07-07 'tool-call loop guardrails now block by default'.
