...
def _make_agent(monkeypatch):
    ...
    stub._maybe_skill_recall_hint = lambda *a, **kw: None
    stub._maybe_memory_recall_hint = lambda *a, **kw: None
    stub._maybe_consult_nudge = lambda *a, **kw: None
    stub._record_file_mutation_result = lambda *a, **kw: None
    stub._record_loaded_skill = lambda *a, **kw: None
    stub._record_voluntary_consult = lambda *a, **kw: None
