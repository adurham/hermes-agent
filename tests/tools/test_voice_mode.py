...
class TestPlayBeep:
    def test_beep_calls_sounddevice_play(self, mock_sd, monkeypatch):
        ...
        # Fork gates sounddevice OUTPUT off on macOS (TCC safety — beeps route
        # through afplay there). This test asserts the sounddevice path, so
        # force the gate open regardless of host platform.
