...
def test_openwakeword_ensures_base_models_for_custom_path(monkeypatch):
    ...
    # Pin an ONNX-friendly platform: on macOS ARM64 the default framework is
    # tflite (see tests below) and engine init would demand a real tflite
    # runtime instead of exercising the download_models contract under test.
