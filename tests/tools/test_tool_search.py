...
class TestCatalogListing:
    ...
    def test_default_listing_cap_bounds_fixed_catalog_overhead(self):
        ...
        # FORK: "auto" keeps the thresholded activation gate (see
        # test_no_defer_lists_respects_auto_threshold and the sticky_active
        # latch), so force activation explicitly — this test targets the
        # listing budget cap, not the activation decision.
