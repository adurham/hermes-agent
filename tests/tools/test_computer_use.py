...
class TestCaptureAppFilterNoMatch:
    ...
    def test_linux_default_capture_skips_gnome_shell_helper(self):
        ...
        # The helper-window skip is gated on sys.platform == "linux"
        # (_select_capture_target); pin the platform so the test exercises
        # the Linux path regardless of the host OS. The _NET_ACTIVE_WINDOW
        # probe is stubbed out so no real xprop subprocess is attempted.
