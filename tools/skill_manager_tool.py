...
def _edit_skill(name: str, content: str) -> Dict[str, Any]:
    ...
    # External-dirs guard first: an external skill's refusal should name the
    # ownership boundary, not the curator-provenance policy (same ordering as
    # _patch_skill / _remove_file).
