...
def memory_tool(
    ...
    # Upstream's shared validator supersedes the fork's inline
    # target-not-in-{memory,user} check: same validation, plus a
    # target_enabled() gate for targets disabled in memory config.
...
MEMORY_SCHEMA = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "content": {
                "type": "string",
                "description": "Entry content. Required for 'add' and 'replace' (both tiers). Alias: 'new_text' is also accepted (mirrors old_text).",
            },
            "old_text": {
                "type": "string",
                "description": (
