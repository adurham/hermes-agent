...
def check_web_api_key() -> bool:
    ...
    try:
        ...
        # Upstream's stricter readiness predicate (keyed OR keyless-capable), but kept as a
        # fall-THROUGH rather than upstream's unconditional `return`: the fork's
        # Anthropic-native web-search path below is a legitimate second source of
        # availability, and returning False here would make it dead code.
        if _provider_is_ready(get_active_search_provider()) or _provider_is_ready(
