...
_BROWSER_TOOL_TABLE = (
    ...
    ("browser_type", "⌨", None, {"ref": "", "text": ""}),
    ("browser_scroll", "📜", None, {"direction": "down"}),
    ("browser_back", "◀", None, {}),
    ("browser_press", "⌨", None, {"key": ""}),
    ("browser_get_images", "🖼", _install.check_browser_requirements, {}),
    ("browser_vision", "👁", _install.check_browser_vision_requirements, {"question": "", "annotate": False}),
    ("browser_console", "🖥", _install.check_browser_requirements, {"clear": False, "expression": None}),
)
