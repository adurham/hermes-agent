...
for _schema, _handler, _desc, _emoji in (
    ...
    (FEISHU_DRIVE_REPLY_SCHEMA, _handle_reply_comment, "Reply to a document comment", "\u2709"),  # bare (no VS-16): fork emoji-width fix
    (FEISHU_DRIVE_ADD_COMMENT_SCHEMA, _handle_add_comment, "Add a whole-document comment", "\u2709"),  # bare (no VS-16)
):
    registry.register(
